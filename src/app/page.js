...
export default function Portfolio() {
  ...
  return (
    <main
      id="portfolio"
      className="bg-mainBg bg-cover w-[100vw] mobile:landscape:snap-none tablet:landscape:snap-none sm:snap-y sm:snap-mandatory h-screen overflow-y-scroll no-scrollbar scroll-smooth"
    >
